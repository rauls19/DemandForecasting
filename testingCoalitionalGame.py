...
coalgame_lm = cg.CoalitionalGame(lm_model, columns, x_train, y_train, x_test, y_test, m = 5)
#coalgame_lm.explainerContribution(['NUMERO_DEUDOR_PAIS_ID', 'TEMPORADA_COMERCIAL_ID'])
...
#coalgame_xgb = cg.CoalitionalGame(xgbm, columns, x_train, y_train, x_test, y_test, m = 5)
#coalgame_xgb.explainerContribution(['NUMERO_DEUDOR_PAIS_ID'])
# END